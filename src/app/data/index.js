...
const servicesData = [
  {
    ...
    description: "Enhance your vehicle’s look, comfort, and protection with...",
  },
  {
...
export const AboutData = [
  {
    title: "Our Vision",
    content:
      "To be a global leader in engineering, construction, and automotive services, recognized for our commitment to innovation, quality, and sustainability.",
    icon: Eye,
  },
  {
    title: "Our Mission",
    content:
      "To deliver exceptional engineering and automotive solutions that exceed client expectations through innovation, expertise, and a dedication to sustainability.",
    icon: Target,
  },
];
...
export const branchesOverview = [
  {
    ...
    shortDescription:
      "Specializes in turnkey contracting, engineering design, and fit-out works.",
  ...
  },
  {
    ...
    shortDescription:
      "Provides construction, fit-out, 3M films, and smart glass technology solutions.",
  ...
  },
  {
    ...
    shortDescription:
      "Oversees global operations and manages construction projects in Canada.",
  ...
  },
  {
    ...
    location: "Sitrah, Bahrain",
    shortDescription:
      "Focused on healthcare design, construction, and turnkey medical facilities.",
