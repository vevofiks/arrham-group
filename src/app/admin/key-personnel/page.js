          ...
          <div className="flex flex-col gap-4 sm:gap-6">
            <div>
              ...
              <p className="text-slate-600 text-sm sm:text-base lg:text-lg">
                Create, update, and view branch key personnel
              </p>
            </div>
        ...
        {loading ? (
            ...
            {filteredPersonnel.map((p) => (
              ...
              >
                ...
                <div className="p-4 sm:p-6">
                  ...
                  <p className="text-sm text-lgreen font-medium mb-2">
                    {p.qualification || "Not set"}
                  </p>
                  <p className="text-xs text-slate-500 mb-3">
                    {p.yearOfExperience}{" "}
                    {p.yearOfExperience === 1 ? "year" : "years"} of experience
                  </p>
          ...
          <div className="text-center py-16 sm:py-24">
            ...
            <p className="text-sm sm:text-base text-slate-600 mb-4 sm:mb-6">
              {selectedBranch
                ? "Start by adding your first key personnel"
              ...
              <div className="p-4 sm:p-6">
                <div className="space-y-6">
                  ...
                  <div className="bg-slate-50 rounded-xl p-4">
                    ...
                    <p className="text-lg font-semibold text-slate-900">
                      {selectedPersonnel.position || "Not set"}
                    </p>
                  </div>
                  <div className="bg-slate-50 rounded-xl p-4">
                    <h4 className="text-sm font-medium text-slate-600 mb-1">
                    ...
                    <p className="text-lg font-semibold text-slate-900">
                      {selectedPersonnel.qualification || "Not set"}
                    </p>
                  </div>
                  <div className="bg-slate-50 rounded-xl p-4">
                    <h4 className="text-sm font-medium text-slate-600 mb-1">
                    ...
                    <p className="text-lg font-semibold text-slate-900">
                      {selectedPersonnel.yearOfExperience}{" "}
                      {selectedPersonnel.yearOfExperience === 1
                        ? "year"
                        : "years"}
                    </p>
                  </div>
                ...
                <div className="space-y-4 sm:space-y-6">
                    ...
                    {modalType === "edit" &&
                      (!formData.position ||
                        ...
                        <p className="text-yellow-600 text-sm mt-1">
                          Position not set. Please add one.
                        </p>
                      )}
                  </div>
                  ...
                  <div>
                    ...
                    {modalType === "edit" &&
                      (!formData.qualification ||
                        ...
                        <p className="text-yellow-600 text-sm mt-1">
                          qualification not set. Please add one.
                        </p>
                      )}
                  </div>
                        ...
                        if (e.target.value) {
                          ...
                          if (years > 45) {
                            setErrors((prev) => ({
                              ...prev,
                              yearOfExperience:
                                "Years of experience cannot exceed 45",
                            }));
                          } else {
                            setErrors((prev) => {
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="text-xs text-slate-500">
                        {formData.description.length}/75 characters
                      </span>
                    </div>
                    <textarea
                      ...
                      onChange={(e) => {
                        ...
                        if (charCount > 75) {
                          setErrors((prev) => ({
                            ...prev,
                            description: `Description must not exceed 75 characters. Current: ${charCount} characters`,
                          }));
                        } else {
                          setErrors((prev) => {
                            const newErrors = { ...prev };
                  ...
                  <div>
                    ...
                    >
                      ...
                      />
                      <label
                        htmlFor="personnel-image-upload"
