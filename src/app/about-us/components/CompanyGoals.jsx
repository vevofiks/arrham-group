        ...
        >
          ...
          >
            ...
            <motion.div
              ...
              transition={{ duration: 0.3 }}
            >
              <div className="w-16 h-16 rounded-full bg-linear-to-br from-emerald-400 to-teal-400 flex items-center justify-center shadow-xl">
            ...
            <div className="absolute -top-4 -right-4 w-24 h-24 bg-linear-to-br from-emerald-400/20 to-teal-400/20 rounded-full blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
            <div className="absolute -bottom-6 -left-6 w-32 h-32 bg-linear-to-br from-cyan-400/10 to-emerald-400/10 rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
          </motion.div>
        </motion.div>
      </div>
    </section>
