          ...
          >
            <div className="relative overflow-hidden rounded-2xl shadow-2xl">
              <Image 
                ...
                priority
              />
              <div className="absolute inset-0 bg-gradient-to-tr from-teal-500/20 to-cyan-400/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
            </div>
          </motion.div>
          ...
          <div className="space-y-8 lg:mt-0">
            ...
            >
              <h2 className="text-5xl lg:text-5xl font-extrabold tracking-tight">
                <motion.span 
                  className="bg-gradient-to-r from-emerald-400 via-teal-400 to-cyan-400 decoration-emerald-400 text-transparent bg-clip-text block"
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.6, delay: 0.6 }}
                  viewport={{ once: true }}
